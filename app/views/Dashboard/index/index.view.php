<?php use App\Process\Template;?>
      ...
      <div class="page-content">
          ...
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Dashboard <?php echo $name?></h2>
          </div>
        </div>
...
<!--                    </div>-->
<!--                    <div class="item d-flex align-items-center">-->
<!--                      <input type="checkbox" id="input-2" name="input-2" checked class="checkboxc-template">-->
...
<!--                      <div class="profile"><img src="--><?//= Template::asset('admin/img/avatar-3.jpg')?><!--" alt="..." class="img-fluid">-->
...
<!--                      <div class="profile"><img src="--><?//= Template::asset('admin/img/avatar-2.jpg')?><!--" alt="..." class="img-fluid">-->
...
<!--                      <div class="profile"><img src="--><?//= Template::asset('admin/img/avatar-1.jpg')?><!--" alt="..." class="img-fluid">-->
...
<!--                      <div class="profile"><img src="--><?//= Template::asset('admin/img/avatar-5.jpg')?><!--" alt="..." class="img-fluid">-->
